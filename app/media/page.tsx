...
export const metadata: Metadata = {
  ...
  description:
    'National media appearances by Evin Lim, founder of AA Alive Sdn Bhd (ISO 14001 & ESG Malaysia): BERNAMA TV panel, RTM news commentary and the Superbrands Malaysia CEO interview.',
  openGraph: {
    title: 'Media Coverage | ISO 14001 & ESG Malaysia',
    description:
      'National media appearances by Evin Lim, founder of AA Alive Sdn Bhd: BERNAMA TV, RTM and Superbrands Malaysia.',
    url: 'https://esgiso.com/media',
    type: 'website',
  },
  alternates: {
    canonical: 'https://esgiso.com/media',
  },
}
        ...
        <section className="py-16 px-4 sm:px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-12">
              ...
              , has appeared in national media on Malaysian industry and compliance topics.
            ...
            <p className="text-gray-600 mb-6">
              ...
              series (December 2025) on the official Superbrands Limited channel. The{' '}
              <strong className="text-gray-900">Superbrands Malaysia 2025 (Malaysia&apos;s Choice)</strong>{' '}
              award was made to AA Alive&apos;s medical-support brand, Evin Limb Specialist.{' '}
              <a
