      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
          ...
          >
            ...
            Get Your Free ESG Readiness Assessment
          </a>
        </div>
        <a href="#pricing" className="text-sm text-primary-600 hover:text-primary-700 font-medium underline">
          See our 3 pricing packages
        </a>

        <div className="mt-16 grid grid-cols-3 gap-8 max-w-lg mx-auto">
          <div className="text-center">
            <div className="text-3xl font-bold text-primary-600">RM 2.4B+</div>
            <div className="text-sm text-gray-500">Green Contracts Clients Qualify For</div>
          </div>
          <div className="text-center">
