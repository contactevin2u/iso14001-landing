    ...
    <section className="pt-24 sm:pt-32 pb-16 sm:pb-20 px-4 sm:px-6 bg-gradient-to-b from-primary-50 to-white">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
          ISO 14001 &amp; ESG Consulting
          <span className="block text-primary-600">Prepare for ISO 14001 Certification</span>
        </h1>
        ...
        <div className="mt-16 grid grid-cols-3 gap-8 max-w-lg mx-auto">
          <div className="text-center">
            ...
            <div className="text-sm text-gray-500">First Consultation</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-primary-600">MY</div>
            <div className="text-sm text-gray-500">Nationwide Site Visits</div>
          </div>
          <div className="text-center">
