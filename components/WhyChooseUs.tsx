const reasons = [
  {
    ...
    description: 'ISO 14001 can be combined with ISO 9001 and ISO 45001 in one integrated management system.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Package prices are published. Certification body audit fees are quoted separately.',
  },
]
    ...
    <section id="why-us" className="py-20 px-4 sm:px-6 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl sm:text-4xl font-bold text-center text-gray-900 mb-4">
          Why Work With AA Alive on ISO 14001
        </h2>
        <p className="text-lg text-gray-600 text-center max-w-2xl mx-auto mb-12">
          Founded by Evin Lim in 2016 — you work directly with our own consultants
        </p>
