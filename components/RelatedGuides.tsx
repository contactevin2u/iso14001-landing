 ...
 */
const GUIDES = [
  { href: '/iso-14001-certification-malaysia', title: 'ISO 14001 Certification Malaysia' },
  { href: '/iso-14001-requirements', title: 'ISO 14001 Requirements' },
  { href: '/iso-14001-certification-process', title: 'ISO 14001 Certification Process' },
  { href: '/iso-14001-cost-malaysia', title: 'ISO 14001 Certification Cost in Malaysia' },
  { href: '/iso-14001-benefits', title: 'Benefits of ISO 14001' },
  { href: '/about', title: 'About AA Alive Sdn Bhd' },
]

export default function RelatedGuides({
  current,
  heading = 'Related ISO 14001 guides',
}: {
  current?: string
  heading?: string
}) {
