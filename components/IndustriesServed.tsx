const industries = [
  {
    name: 'Manufacturing',
    description: 'Automotive parts, electronics, plastics and metal fabrication. Often driven by customer and supply-chain requests for ISO 14001.',
    icon: (
  ...
  {
    name: 'Oil & Gas',
    description: 'Upstream, downstream and service providers preparing for client vendor-registration and HSE expectations.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Construction',
    description: 'Main contractors, sub-contractors and building material suppliers, including green building and GBI projects.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Food & Beverage',
    description: 'Food processing, packaging and distribution. ISO 14001 can sit alongside existing HACCP and food safety systems.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Hospitals, clinics, pharmaceutical companies and medical device distributors, alongside existing MDA and KKM compliance work.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Property developers, facility management and building maintenance companies working on green building and township sustainability.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section className="py-20 px-4 sm:px-6 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-lg text-gray-600 text-center max-w-3xl mx-auto mb-14">
          From manufacturing to technology companies, we tailor the environmental management system
          to your industry&apos;s environmental aspects and compliance obligations.
        </p>
