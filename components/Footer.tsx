      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <div className="flex items-center gap-3">
              <a
                href="https://www.facebook.com/katilhospitalmy"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/katilhospitalmy"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-gray-700 transition-colors"
              ...
              <a
                href="https://www.tiktok.com/@katilhospitalprihatin_"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-gray-700 transition-colors"
                aria-label="TikTok"
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-center">
          ...
          <p className="text-xs text-gray-600">
            Empowering Malaysian businesses through ISO 14001 environmental management certification.
          </p>
        </div>
      </div>
    </footer>
