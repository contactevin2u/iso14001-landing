      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden lg:flex items-center gap-6">
            <a href="#what-is-iso" className="text-gray-600 hover:text-primary-600 transition-colors">
              What is ISO 14001
            </a>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <a
              href="#contact"
              className="inline-flex px-5 py-2 bg-primary-600 text-white font-medium rounded-lg hover:bg-primary-700 transition-colors"
            >
            ...
            <nav className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3 pt-4 border-t border-gray-100">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-5 py-3 bg-green-500 text-white font-medium rounded-lg"
                >
                ...
                <a
                  href="#contact"
                  onClick={() => setIsOpen(false)}
                  className="inline-flex justify-center px-5 py-3 bg-primary-600 text-white font-medium rounded-lg"
                >
                  Get Free Consultation
                </a>
              </div>
