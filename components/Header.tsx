    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-100">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <a
            href="#contact"
            className="hidden md:inline-flex px-5 py-2.5 bg-primary-600 text-white font-medium rounded-lg hover:bg-primary-700 transition-colors"
          >
          ...
          <div className="md:hidden py-4 border-t border-gray-100">
            <nav className="flex flex-col gap-4">
              ...
              <a
                ...
                className="inline-flex justify-center px-5 py-2.5 bg-primary-600 text-white font-medium rounded-lg"
              >
                Get Free Consultation
              </a>
            </nav>
