...
export const SITE_URL = 'https://esgiso.com'
...
export const FOUNDER_VIDEOS: FounderVideo[] = [
  ...
  },
  {
    ...
    description:
      'Superbrands Malaysia CEO Interviews 2025 with Evin Lim on the official Superbrands Limited channel. The Superbrands Malaysia 2025 (Malaysia’s Choice) award was made to AA Alive’s medical-support brand, Evin Limb Specialist.',
    publisher: 'Superbrands Limited',
    uploadDate: '2025-12-09T17:04:50+08:00',
    duration: 'PT2M2S',
    context:
      'Evin Lim was interviewed in the Superbrands Malaysia CEO Interviews 2025 series (December 2025) on the official Superbrands Limited channel. The Superbrands Malaysia 2025 (Malaysia’s Choice) award was made to AA Alive’s medical-support brand, Evin Limb Specialist.',
  },
]
